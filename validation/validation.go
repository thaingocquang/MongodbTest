...
//}
//
//func validateStringRequired(input string) bool {
//	if len(input) == 0 {
//		return false
//	} else {
//		return false
...
//}
//
//func validateStruct(v interface{}) (bool, string) {
//	validateResult := true
//	errmsg := "success"
//
...
//				}
//			case "required":
//				nestedResult := validateStringRequired(val)
//				if nestedResult == false {
//					errmsg = "validate string require failed, field val is: " + val
//					validateResult = false
//					return validateResult, errmsg
//				}
//			}
